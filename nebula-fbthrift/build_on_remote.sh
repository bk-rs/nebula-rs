...
sed -i '5i\#![allow(clippy::all)]' /tmp/nebula-fbthrift-common-v2/src/lib.rs
sed -i '5i\#![allow(clippy::all)]' /tmp/nebula-fbthrift-graph-v2/src/lib.rs 
sed -i '5i\#![allow(clippy::all)]' /tmp/nebula-fbthrift-meta-v2/src/lib.rs
sed -i '5i\#![allow(clippy::all)]' /tmp/nebula-fbthrift-raftex-v2/src/lib.rs
sed -i '5i\#![allow(clippy::all)]' /tmp/nebula-fbthrift-storage-v2/src/lib.rs
...
sed -i '5i\#![allow(clippy::all)]' /tmp/nebula-fbthrift-common-v1/src/lib.rs
sed -i '5i\#![allow(clippy::all)]' /tmp/nebula-fbthrift-graph-v1/src/lib.rs
sed -i '5i\#![allow(clippy::all)]' /tmp/nebula-fbthrift-meta-v1/src/lib.rs
sed -i '5i\#![allow(clippy::all)]' /tmp/nebula-fbthrift-raftex-v1/src/lib.rs
sed -i '5i\#![allow(clippy::all)]' /tmp/nebula-fbthrift-storage-v1/src/lib.rs 
