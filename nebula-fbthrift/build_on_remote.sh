...
mv /tmp/consts.rs /tmp/nebula-fbthrift-common-v3/src/consts.rs
mv /tmp/errors.rs /tmp/nebula-fbthrift-common-v3/src/errors.rs

sed -i 's/^pub use :: as types;/pub mod types;/' /tmp/nebula-fbthrift-common-v3/src/lib.rs
sed -i 's/^pub use ::::consts as consts;/pub mod consts;/' /tmp/nebula-fbthrift-common-v3/src/lib.rs
echo 'pub mod double;' >> /tmp/nebula-fbthrift-common-v3/src/lib.rs

sed -i '/^pub mod consts;/d' /tmp/nebula-fbthrift-common-v3/src/types.rs
...
sed -i 's/^pub const version/\/\/ pub const version/' /tmp/nebula-fbthrift-common-v3/src/consts.rs
